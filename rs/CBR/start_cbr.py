...
def test_cbr(target_reader_list = [],training = 'user_click_data.txt',testing = 'user_click_data.txt'):
    input_target_len = len(target_reader_list)
    #use training data to build user vector
    testing = Documents(testing,True)
    ...
    training = Documents(training,True)
